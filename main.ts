...
namespace claps {
    ...
    class ClapDetector {
        ...
        private onWakeDetected: ()=>void;   // triggered on wake - i.e. if a handler is matched
        ...
        /**
         * A handler that will run every time a handler or capture handler is found to be valid/matched.
         * Means that the wake sequence for that handler has been met so it is woken.
         */
